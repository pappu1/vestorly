Given(/^I am signed in for build your list$/) do
  visit '/sagar'
...
Given(/^I am signed in for list added feature$/) do
  visit '/sagar'
  fill_in "username", with: "pappusagar@gmail.com"
  fill_in "password", with: "sagar@perfect"
  click_on "Log in to Your Account"
...
Given(/^I am signed in for linkedIn selectall feature$/) do
  visit '/sagar'
  fill_in "username", with: "pappusagar@gmail.com"
  fill_in "password", with: "sagar@perfect"
  click_on "Log in to Your Account"
...
Given(/^I am signed in for linkedIn unselectall feature$/) do
  visit '/sagar'
  fill_in "username", with: "pappusagar@gmail.com"
  fill_in "password", with: "sagar@perfect"
  click_on "Log in to Your Account"
...
Given(/^I fill out the login form with valid credentials for your network settings$/) do
  fill_in "username", with: "pappusagar@gmail.com"
  fill_in "password", with: "sagar@perfect"
  click_on "Log in to Your Account"
end
